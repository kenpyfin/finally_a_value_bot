...
- **Settings → Local delegate**: local base URL, model, tool-calling test (`tools_ok`).
- **Settings → Runtime**: choose Single turn vs Classic · Cost routing (syncs `routing_enabled` in DB).

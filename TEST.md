...
| 10.3 | Web fetch             | "Fetch [https://example.com](https://example.com)"                                         | Returns plain text with HTML tags stripped           |
| 10.4 | Web fetch large page  | Fetch page >20KB                                                                           | Content truncated to 20KB                            |
| 10.5 | Web fetch invalid URL | "Fetch [https://thisdomaindoesnotexist12345.com](https://thisdomaindoesnotexist12345.com)" | Returns network error, no crash                      |
...
| #    | User Story                  | Steps                                                        | Expected                                     |
| ---- | --------------------------- | ------------------------------------------------------------ | -------------------------------------------- |
| 17.1 | Open webpage                | "Open [https://example.com](https://example.com) in browser" | Returns page content/status                  |
